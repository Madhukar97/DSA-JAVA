...
public class LongestPalindromicSubsequence {
    ...
    public int rec(int i1, int i2, String s){
        if( i1<0 || i2 == s.length()){
            return 0;
        }

        if(s.charAt(i1) == s.charAt(i2) ) {
            return 1+rec(i1-1,i2+1,s);
        }
    ...
    public int recMem(int i1, int i2, String s, int[][] dp){
        if( i1<0 || i2 == s.length()){
            return 0;
        }
    ...
    public int longestPalindromeSubseqTabWithSpaceOptimization(String s) {
